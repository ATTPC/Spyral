...
from .jit.jit_track_generator import GeneratorParams, generate_tracks, TrackInterpolator, create_interpolator
from .core.workspace import Workspace
from .jit.jit_solver_interp import solve_physics_interp, Guess
...
def phase_4_interp_jit(run: int, ws: Workspace, solver_params: SolverParameters, det_params: DetectorParameters, nuclear_map: NuclearDataMap):
    start = time()
