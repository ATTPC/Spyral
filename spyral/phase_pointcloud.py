...
def phase_pointcloud(run: int, ws: Workspace, pad_map: PadMap, trace_params: TraceParameters, frib_params: FribParameters, detector_params: DetectorParameters, queue: SimpleQueue):
